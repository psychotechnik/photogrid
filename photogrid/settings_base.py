...
if environ.get('VIRTUAL_ENV'):
    DATA_DIR = os.path.join(environ.get('VIRTUAL_ENV'), 'var/data')
else:
...
MEDIA_ROOT = os.path.join(PROJECT_DIR, 'photogrid', 'media')
...
GRAPPELLI_ADMIN_TITLE = "Chess Grid"
...
EMAIL_SUBJECT_PREFIX = 'photogrid.you [Django] '
DEFAULT_FROM_EMAIL = 'noreply@photogrid.you'
